...
import {TestChosenFilmUI} from "../ChosenFilmUI";
import {
    chosenFilmId,
    chosenFilmUIProps
} from "./stubProps";
...
const setUp = (props) => shallow(<TestChosenFilmUI {...props} />);
...
describe('<ChosenFilmUI />', () => {
    ...
    beforeEach(() => {
        component = setUp(chosenFilmUIProps);
        article = component.find(`.${styles.fullInfo}`);
    })
